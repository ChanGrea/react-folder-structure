...
describe('RESOURCE_CREATE_SUCCESS', () => {
  it('adds the new data to the initial state', () => {
    expect(
      reducer(initialState, action(actions.RESOURCE_CREATE_SUCCESS, 1)),
...
describe('RESOURCE_LIST_READ_REQUEST', () => {
  it('keeps the list initial state', () => {
    expect(
      reducer(initialState, action(actions.RESOURCE_LIST_READ_REQUEST)),
    ).toEqual(state())
  })
...
describe('RESOURCE_DETAIL_READ_REQUEST', () => {
  it('keeps the detail initial state', () => {
    expect(
      reducer(initialState, action(actions.RESOURCE_DETAIL_READ_REQUEST)),
    ).toEqual(state())
  })
...
describe('RESOURCE_DELETE_SUCCESS', () => {
  it('keeps the initial state', () => {
    expect(
      reducer(initialState, action(action.RESOURCE_DELETE_SUCCESS)),
